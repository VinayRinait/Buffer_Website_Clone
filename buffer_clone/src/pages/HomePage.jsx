  ...
  return (
    <>
      ...
      >
        ...
        <Box>
          <Image src="https://buffer.com/static/illustrations/all-channels-3.webp" />
        </Box>
      </Flex>
      ...
      >
        <VStack>
          <Heading color="#2039f4">10 years</Heading>
          <Text>in business</Text>
        </VStack>
        <VStack>
          <Heading color="#2039f4">1,40000</Heading>
          <Text>users</Text>
        </VStack>
        <VStack>
          <Heading color="#2039f4">100k+</Heading>
          <Text>monthly blog readers</Text>
        </VStack>
        <VStack>
          <Heading color="#2039f4">1.2m+</Heading>
