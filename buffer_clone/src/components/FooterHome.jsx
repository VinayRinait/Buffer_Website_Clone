  ...
  return (
    ...
    >
      <Flex direction="column" mb="20px" mr="20px">
        ...
        <Text fontSize={13}>Copyright ©2022</Text>
        <Text fontSize={13}>Buffer | Privacy | Terms | Security</Text>
      </Flex>
      <VStack align={["center", "center", "center", "flex-start"]} mb="20px">
        <Heading fontSize={22}>Tools</Heading>
      ...
      <VStack align={["center", "center", "center", "flex-start"]} mb="20px">
        <Heading fontSize={22}>Resouces</Heading>
        <Text>Blog</Text>
      ...
      <VStack align={["center", "center", "center", "flex-start"]} mb="20px">
        <Heading fontSize={22}>Support</Heading>
